...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for Erium exchanges.' },
      '/info/pairs': { title: t('Pairs'), description: 'View statistics for Erium exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for Erium exchanges.' },
      '/nfts/collections': { basePath: true, title: t('Collections') },
      '/nfts/activity': { title: t('Activity') },
      '/profile': { basePath: true, title: t('Profile') },
      '/pancake-squad': { basePath: true, title: t('Erium Squad') },
      '/pottery': { basePath: true, title: t('Pottery') },
    },
    defaultTitleSuffix: t('Erium'),
  }
}
